...
import { SimplifiedMCPServer } from '../../src/mcp/server.js';
import { JsonRpcClient } from '../../src/drupal/json-rpc-client.js';
import { TokenExtractor } from '../../src/mcp/token-extractor.js';

// Mock the Drupal client
jest.mock('../../src/drupal/json-rpc-client.js');
