...
Create the foundational JSON-RPC client structure with HTTP transport, request/response handling,
and basic error management for Drupal API communication.
...
Focus on creating a clean, extensible foundation that can be enhanced with authentication and
advanced features. Use Axios or similar HTTP client library. Ensure proper TypeScript typing
