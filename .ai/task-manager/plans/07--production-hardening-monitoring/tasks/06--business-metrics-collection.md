...
## Objective
Implement business metrics collection system for user engagement, content performance, and subscription impact analytics to drive product insights.
...
Focus on actionable business insights while maintaining user privacy. Implement efficient time-series data collection that won't impact MCP connection performance.