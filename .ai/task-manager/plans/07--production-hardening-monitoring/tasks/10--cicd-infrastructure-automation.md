...
Build comprehensive CI/CD pipeline with infrastructure automation, containerization, zero-downtime
deployment, and automated rollback capabilities for production deployment.

## Skills Required

- **ci-cd**: Continuous integration/deployment, automated testing, and deployment pipelines
- **infrastructure-as-code**: Automated provisioning, configuration management, and environment
  setup
...
Focus on Railway deployment platform as specified in the plan. Implement comprehensive health checks
to ensure deployment quality and automatic rollback on failures.
