...
Install and configure all essential dependencies required for the MCP server including the MCP
Protocol SDK, OAuth 2.0 client libraries, PostgreSQL client, HTTP/SSE server capabilities, and
JSON-RPC client for Drupal integration.
