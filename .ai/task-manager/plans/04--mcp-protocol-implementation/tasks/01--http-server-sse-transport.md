...
## Objective
Set up the foundational HTTP server with Server-Sent Events (SSE) transport layer that will serve as the communication backbone for the MCP protocol implementation.
